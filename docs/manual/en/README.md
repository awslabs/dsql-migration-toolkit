...
(foreign keys, by contrast, **are supported and enforced**). This manual calls out
each of these where it matters and shows what the tool does about it, so you don't
have to learn DSQL's rules the hard way.
