...
from dsql_migrator.ui.ai_tools import (
    ...
    AI_TOOLS_SYSTEM_HINT as _AI_TOOLS_SYSTEM_HINT,
...
def build_page(
    ...
    # Read-only AI-DBA tools live in ui/ai_tools.py; wire them to THIS page's stores
    # + Full Load rate/ETA helper via a factory (avoids a circular import with app).
    _ai_tool_execute = build_ai_tool_executor(
        ...
        full_load_rate_eta=_full_load_rate_eta,
    )
